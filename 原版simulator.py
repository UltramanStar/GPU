...
class Job(object):
    ...
    def step(self, seconds, interference=0.0, cluster=None):
        ...
        if not self.placement:
            ...
            if not self.inference or self.status == 'FINISH' or self.submission_time > cluster.clock:#还未提交
        ...
        while seconds > 0 and self.completion_time is None:
            ...
            if not self.inference:
                ...
                self.update_local_bsz(self.placement)#placement没变
...
if __name__ == "__main__":
    ...
    parser.add_argument("--workload", type=str,
                        default="./experiment/workload/small.csv")
